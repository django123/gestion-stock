...
public class ProductService {
	...
	public Boolean updateProductCode(String codeArticle, String newCode) {
		
		try {
			    ProductEntity product  = productRep.getProductById(codeArticle);
			    if(product == null)throw new HttpServiceExceptionHandle("code does not exist !!!");
